...
$(TARGET): $(filter-out $(OBJDIR)/test_%.o,$(OBJECTS)) | $(BINDIR)
	$(CXX) $(CXXFLAGS) -o $@ $^
...
$(TEST_LOCAL_SEARCH_TARGET): $(filter-out $(OBJDIR)/main.o $(OBJDIR)/test_solution_reader.o $(OBJDIR)/test_swap.o,$(OBJECTS)) $(OBJDIR)/test_local_search.o | $(BINDIR)
	$(CXX) $(CXXFLAGS) -o $@ $^
